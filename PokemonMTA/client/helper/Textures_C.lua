...
function Textures:init()
	...
	Textures["icons"].female_icon = dxCreateTexture("res/textures/icons/female_icon.png")
	Textures["icons"].male_icon = dxCreateTexture("res/textures/icons/male_icon.png")
