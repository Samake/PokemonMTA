...
MySQL.createPlayerTable = "CREATE TABLE IF NOT EXISTS `" .. MySQL.accountTable .. "` ( `account_id` BIGINT(20) NOT NULL AUTO_INCREMENT, `account_name` VARCHAR(255), `password` VARCHAR(255) NOT NULL, `skin_id` INT, `player_name` VARCHAR(255), `position` LONGTEXT, `rotation` LONGTEXT, PRIMARY KEY (`account_id`) ) COLLATE=`utf8_general_ci`;"
